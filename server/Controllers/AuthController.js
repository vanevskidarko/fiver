 ...
 * If the user is found and the password is correct, generates a JWT token and sends it back
 * as a cookie in the response.
 *
 * @param {Object} req - The request object containing the username and password.
 * @param {Object} res - The response object used to send the token and user information.
 * @param {Function} next - The next function to be called in the middleware chain.
 * @return {Object} The user information and the generated token.
 */
